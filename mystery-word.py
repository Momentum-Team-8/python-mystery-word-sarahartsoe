...
# difficult easy = 1(4-5 letters), normal = 2(6-7 letters), hard = 3(8+letters)
...
with open("words.txt") as f:
    ...
    print(f)
    number = input("Choose your level. Enter 1 for Easy, 2 for Normal, or 3 for Hard: ")
    if number == 1:
        wordChoice = random.choice(EASY_WORDS)
    
    letter = input("Good choice! What letter do you guess? ")
    if len(letter) >= 2:
